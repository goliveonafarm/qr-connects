          ...
          <div className="mr-auto ml-auto">
            ...
            >
              <svg
                ...
                className={
                  isAttending === "Attending" ? "fill-success hover:fill-blue-500" : "hover:fill-blue-500"
                }
              >
          ...
          <div className="mr-auto ml-auto">
            <button onClick={() => handleChangeAttending("Not Attending")}>
              <svg
                ...
                viewBox="0 0 512 512"
                className={
                  isAttending === "Not Attending" ? "fill-success hover:fill-blue-500" : "hover:fill-blue-500"
                }
              >
