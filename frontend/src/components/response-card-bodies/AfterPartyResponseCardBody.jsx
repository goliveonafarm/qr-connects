  ...
  return (
    <div>
      <div className="flex pb-3">
        <h2 className="card-title text-4xl text-info text-center">
      ...
      <div>
        <div className="flex">
          <div className="mr-auto ml-auto">
            <button
              onClick={() => handleChangeAttending("Attending")}
              title="Attending"
            >
              <svg
                height={"50"}
                ...
                className={
                  formData.attending === "Attending"
                    ? "fill-secondary hover:fill-blue-500"
          ...
          <div className="mr-auto ml-auto">
            <button onClick={() => handleChangeAttending("Not Attending")}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="50"
                width="50"
      ...
      <label className="input input-bordered input-info flex items-center gap-2 text-xl">
        <input
          type="text"
          className="grow text-info  placeholder-info"
      ...
      <div className="flex">
        <div className="mr-auto ml-auto text-info">{`You: ${formData.name || "Anonymous"} - ${
